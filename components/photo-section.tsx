...
const photos = [
  {
    ...
    description: "Speaking at the International AI Conference about machine learning innovations",
    category: "Speaking",
    date: "2023-09-15",
  ...
  },
  {
    ...
    description: "Working with the development team on our latest AI project",
    category: "Work",
    date: "2023-08-20",
    location: "Office",
    likes: 89,
  ...
  },
  {
    ...
    description: "Conducting a workshop on React and Next.js for junior developers",
    category: "Teaching",
    date: "2023-06-05",
    location: "Tech Hub",
    likes: 178,
  ...
  },
  {
    id: 5,
    src: "/placeholder.svg?height=400&width=600",
    title: "Patent Ceremony",
    description: "Receiving patent recognition for AI-powered analytics system",
    category: "Achievement",
    date: "2023-05-18",
